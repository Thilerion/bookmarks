<template>
<div>
	<button class="add-bm-btn" @click="toggleModalAddBookmark">
		<BmSvgIcon icon="plus"/>
		<span class="add-bm-text">Add bookmark</span>
	</button>
</div>
</template>
...
export default {
	...
	methods: {
		toggleModalAddBookmark() {
			this.$store.dispatch('enableModal', 0);
		}
	}
}
</script>
