...
const colourArraysReduced = colourArrays.map(val => {
	val.shift();
	return val;
});

const concatColourArray = [].concat(...colourArrays);
console.log(concatColourArray);

export { colourArrays, colourArraysReduced, concatColourArray };